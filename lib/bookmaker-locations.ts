...
export const COUNTRIES_BY_REGION: Record<RegionSlug, CountrySlug[]> = {
  ...
  africa: [
    ...
    "namibia","republic-of-the-congo","rwanda","saint-helena",
...
export const bookmakerLocations: Record<string, BookmakerLocationMeta> = {
  ...
  betclic: {
    regions: ["europe"],
    availableCountries: ["andorra", "angola", "armenia", "benin", "bolivia", "brazil", "burkina-faso", "cameroon", "canada", "chile", "congo-brazzaville", "republic-of-the-congo", "costa-rica", "croatia", "dominican-republic", "ecuador", "el-salvador", "finland", "france", "gabon", "gibraltar", "guatemala", "honduras", "hong-kong", "hungary", "iceland", "ireland", "italy", "ivory-coast", "japan", "kenya", "kiribati", "lebanon", "liechtenstein", "luxembourg", "north-macedonia", "madagascar", "malta", "mauritius", "mexico", "moldova", "monaco", "montenegro", "morocco", "mozambique", "netherlands", "new-zealand", "nicaragua", "norway", "panama", "peru", "poland", "san-marino", "senegal", "south-africa", "south-korea", "suriname", "switzerland", "togo", "trinidad-and-tobago", "tunisia", "ukraine", "venezuela"],
  },
  mybookie: {
    regions: ["north-america", "europe", "asia", "south-america", "africa", "oceania"],
    availableCountries: ["aland-islands","andorra","argentina","barbados","belize","bermuda","bolivia","botswana","brazil","canada","chile","colombia","croatia","czech-republic","dominica","ecuador","egypt","equatorial-guinea","falkland-islands","faroe-islands","georgia","germany","ghana","greenland","grenada","guatemala","guyana","haiti","honduras","iceland","italy","jamaica","japan","kenya","kosovo","laos","lesotho","liechtenstein","lithuania","luxembourg","macau","malaysia","mexico","micronesia","moldova","monaco","mongolia","mozambique","myanmar","namibia","new-zealand","nicaragua","nigeria","norway","panama","paraguay","peru","philippines","portugal","puerto-rico","qatar","republic-of-the-congo","saint-barthelemy","saint-kitts-and-nevis","saint-lucia","saint-vincent-and-the-grenadines","samoa","san-marino","senegal","singapore","slovakia","slovenia","solomon-islands","south-africa","sri-lanka","suriname","sweden","switzerland","taiwan","tanzania","thailand","tonga","trinidad-and-tobago","tunisia","united-states","uruguay","us-virgin-islands","venezuela","zambia","zimbabwe"],
  },
  pmu: {
    regions: ["europe"],
